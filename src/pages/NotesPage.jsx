...
import { createNotes, getNotes } from "../Redux/notes/note.action.js";
      ...
      <>
        ...
        >
          ...
          <ModalContent>
            ...
            <Textarea mt={8} value={content} placeholder={"Please enter descriptions"} onChange={(e)=>setContent(e.target.value)}></Textarea>
